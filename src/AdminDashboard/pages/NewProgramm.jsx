	...
	return (
		<div className='bg-neutral-100'>
			...
			<div className='flex'>
				...
				<div className='items-center pb-24 mx-auto my-auto text-center'>
					<img
					...
					<div>
						...
						<p className='text-base text-[#777] font-medium leading-[146.5%] pb-6'>
							Programs provide a structured approach to address specific health <br /> needs and promote a
			...
			{isFirstModalOpen && (
				<div className='fixed inset-0 z-50 flex items-center justify-center bg-gray-400 bg-opacity-50'>
					<div className='bg-white rounded-lg shadow-md p-8 w-[435px] h-[586px] rounded-10'>
						...
						<h2 className='text-[28px] font-bold mb-5 text-[#00395B]'>Create a new program</h2>
						...
						<textarea
							...
							className='w-full h-24 px-3 py-2 mb-5 border rounded resize-none'></textarea>
			...
			{isSecondModalOpen && (
				<div className='fixed inset-0 z-50 flex items-center justify-center bg-gray-500 bg-opacity-50'>
					<div className='bg-white rounded-lg shadow-md p-8 w-[435px] h-[586p rounded-10'>
						...
						<h2 className='text-[28px] font-bold mb-5 text-[#00395B]'>Almost done!</h2>
