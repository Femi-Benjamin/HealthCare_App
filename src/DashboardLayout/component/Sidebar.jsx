...
const Sidebar = () => {
  return (
    <div className="w-80 h-[918p h-screen bg-[#FFF] text-[#999999]">
      <Link to="/">
      ...
      <ul className="flex-1 px-14 p-10  border-b">
        <Link to="/dashboardd" activeClassName="active-link">
        ...
        <Link to="/staffmembers">
          <div className="flex px-10 gap-3 hover:bg-[#97d0f1] hover:text-[#00395B] hover:rounded-xl">
            <img src={people} alt="" />
            <li className="py-5 cursor-pointer">Staff</li>
          </div>
        </Link>
        ...
        <Link to="/student">
          <div className="flex px-10 gap-3 hover:bg-[#97d0f1] hover:text-[#00395B] hover:rounded-xl">
            <img src={people} alt="" />
            <li className="py-5 cursor-pointer">Students</li>
          </div>
        </Link>
